  ...
  <body>
        ...
        <div class="container">
          ...
          <div class="nav-collapse">
            <ul class="nav">
              ...
              <li class="active"><a href="#">添加卡</a></li>
    ...
    <div class="container">
      <div class="row">
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="register.php">添加新卡</a></li>
        ...
        <div class="span9">
        <form class="form-horizontal" method="post" action="register-action.php">
        <fieldset>
            <legend>添加卡</legend>
            <div class="control-group">
                <label class="control-label" for="id_id">卡号</label>
                <div class="controls">
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input id="id_name" name="name" class="input-middle" type="text">
                </div>
            </div>
            <div class="control-group">
                <label class="control-label" for="department">部门</label>
                <div class="controls">
                    <input id="department" name="department" class="input-middle" type="text">
                </div>
            </div>
            <div>
                <label class="control-label" for="type">类别</label>
                <div class="controls">
                    <input id="type" name="type" class="input-middle" type="text">
                </div>
            </div>
