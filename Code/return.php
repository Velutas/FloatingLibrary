				...
				<div class="container">
					...
					<div class="nav-collapse">
						<ul class="nav">
							...
							<li class="active"><a href="#">还书</a></li>
				...
				<div class="span3">
					<div class="well sidebar-nav">
						<ul class="nav nav-list">
							...
							<li class="active"><a href="return.php">还书</a></li>
...
<?php } else if ($_GET['error']) { ?>
				<div class="alert alert-error">
					还书失败，<?php echo $_GET['error']; ?>。
				</div>
<?php } ?>
				<form class="form-horizontal" action="return-action.php">
				<fieldset>
						<legend>还书</legend>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" class="input-xlarge" id="card_id" name="card_id" value="<?php echo $_GET['card_id']; ?>">
							</div>
						</div>
						<div class="control-group">
